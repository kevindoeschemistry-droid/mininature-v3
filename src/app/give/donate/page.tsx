...
import { Heart, ArrowRight, Leaf, Users, TreePine, CheckCircle } from "lucide-react";
            ...
            <div className="bg-white rounded-organic-lg p-8 shadow-card">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                {AMOUNTS.map((a) => (
                  ...
                  >
                    ...
                    <div className="font-display font-bold text-xl text-deep-forest">
                      ${a.amount}
                    </div>
                    <div className="text-xs text-forest-mid mt-0.5">
                      {a.label}
                    </div>
                    {a.highlighted && (
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="flex-1 py-2.5 rounded-full bg-lichen-cream text-deep-forest text-sm font-medium hover:bg-sage/20 transition-colors">
                    Monthly
                  </button>
                </div>
              </div>
              ...
              {/* Donor info */}
              <h3 className="font-display font-semibold text-lg text-deep-forest mb-4">
                Your Information
              </h3>
