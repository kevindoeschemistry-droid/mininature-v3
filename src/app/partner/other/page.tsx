          ...
          <div className="max-w-2xl mx-auto">
            ...
            <form className="space-y-5">
              ...
              <div>
                ...
                <input type="text" placeholder="Your company, school, or organization"
                  className="w-full rounded-xl border border-lichen-cream bg-white px-4 py-3 text-sm text-deep-forest placeholder:text-sage focus:outline-none focus:ring-2 focus:ring-reserve-green" />
              </div>
              <div>
              ...
              <div>
                ...
                <textarea required rows={5} placeholder="What kind of partnership are you imagining? What are your goals? How do you think we could work together?"
