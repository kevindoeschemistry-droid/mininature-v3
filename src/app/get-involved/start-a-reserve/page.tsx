...
import { ArrowRight, Check, TreePine, Users, MapPin, BookOpen, Package, QrCode, Heart } from "lucide-react";

export const metadata: Metadata = {
  title: "Start a MiniNature Reserve",
  description: "Turn any small space into a thriving native plant habitat. Free kit, training, and community support. Takes 5 minutes to apply.",
};

const SPACE_TYPES = [
  { emoji: "🏡", label: "Front yard strip" },
  { emoji: "🛤️", label: "Parkway / sidewalk" },
  { emoji: "🏫", label: "Schoolyard corner" },
...
export default function StartAReservePage() {
  return (
        ...
        <div className="relative container-site">
          <div className="max-w-2xl">
            ...
            <p className="text-sage text-lg md:text-xl leading-relaxed mb-8">
              Even a 4×8 ft strip of parkway can become a thriving native plant habitat. No experience needed. We provide the plants, training, and community support.
            </p>
            ...
            <div className="mt-6 text-xs text-sage/70 font-mono-accent">
              Takes 5 minutes · No experience required · Free for qualifying spaces
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container-site">
          ...
          <div className="bg-mint-mist rounded-organic-lg p-8 text-center">
            <p className="font-display text-xl text-reserve-green italic">
              "If you can plant, you can restore."
            </p>
            <p className="text-sm text-forest-mid mt-2">Minimum size: 25 sq ft. No prior gardening experience required.</p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                title: "Apply",
                icon: "📋",
                body: "Tell us about your space — takes 5 minutes. Include your location, approximate size, and how you want to get started. We&apos;ll review and confirm eligibility within a few days.",
                detail: "Online form · 5 minutes · Free",
              },
              {
                n: "02",
                title: "Install",
                icon: "🌿",
                body: "Choose your path: Free DIY Kit, a Community Install Day with volunteers, or Professional Installation for larger spaces. We provide plants, soil amendment, and guidance.",
              ...
              },
              {
                ...
                icon: "🗺️",
                body: "Your reserve gets an official QR-code sign, a permanent map profile, and access to a community of stewards. Volunteers, visitors, and future adopters can find you.",
                detail: "Permanent map listing & profile page",
              },
            ].map((step) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-forest-mid leading-relaxed mb-6">
                You don&apos;t have to do this alone. MiniNature provides the full ecosystem of support to get your reserve started and keep it thriving.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {RESERVE_PATHS.map((path, i) => (
              ...
              >
                ...
                <a href="#apply" className="btn btn-outline text-sm justify-center">
                  {path.cta}
                  <ArrowRight size={14} />
                </a>
              </div>
      ...
      <section className="section-pad bg-reserve-green text-white">
        <div className="container-site text-center">
          ...
          <h2 className="font-display font-bold text-3xl text-white mb-6">
            Join a Growing Network of Urban Reserves
          </h2>
          ...
          <p className="text-sage text-sm max-w-xl mx-auto">
            Every reserve you create adds a node to an urban biodiversity network that grows more resilient, more visible, and more powerful with each addition.
          </p>
        </div>
      </section>
      ...
      <section id="apply" className="section-pad">
        <div className="container-site max-w-2xl">
          <div className="text-center mb-10">
            ...
            <h2 className="font-display font-bold text-3xl md:text-4xl text-deep-forest mb-3">
              Start Your Reserve Application
            </h2>
            <p className="text-forest-mid">
              Takes 5 minutes. We&apos;ll review and respond within 3–5 business days.
            </p>
          </div>
          ...
          <form className="bg-white rounded-organic-lg p-8 shadow-card space-y-6">
            ...
            <div>
              ...
              <textarea
                rows={3}
                placeholder="Tell us about your space, your community, or what excites you about this..."
