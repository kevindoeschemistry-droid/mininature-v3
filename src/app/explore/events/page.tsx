      ...
      <div className="sticky top-[64px] z-30 bg-white border-b border-lichen-cream shadow-sm">
        <div className="container-site py-3">
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-hide">
            ...
            {["All", "Install Day", "Volunteer", "Workshop", "Indigenous Knowledge", "School Program"].map((f) => (
              <button
                key={f}
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="flex items-center justify-between mb-2">
              <h2 className="font-display font-semibold text-deep-forest text-xl">
                Upcoming Events <span className="text-forest-mid font-sans font-normal text-base">({UPCOMING_EVENTS.length})</span>
              </h2>
            </div>
